                    ...
                    <tr class="border-color" data-id="<?= $staff['id']; ?>">
                        ...
                        <td class="text-gray text-medium text-sm p-3 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-4">
                                <button title="Edit" id="editModalBtn" class="w-6 h-6" onclick="showEditModal(<?= $staff['id'] ?>)"><img src="../images/edit-svgrepo-com.svg" alt=""></button>
                                <button title="Delete" id="deleteModalBtn" class="w-6 h-6" onclick="showDeleteModal(<?= $staff['id'] ?>)"><img src="../images/delete-svgrepo-com.svg" alt=""></button>
                            </div>
                        </td>
                    </tr>   
                <?php
    ...
    <div class="w-full  max-w-lg p-5 relative mx-auto h-80 rounded-xl shadow-lg  bg-white ">
        <div class="">
            ...
            <div class="p-3  mt-2 text-center space-x-4 md:block">
                <button title="Delete" class="deleteStaff mb-2 md:mb-0 bg-red-500 border border-red-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600" data-id=<?= $staff['id']; ?> >Delete</button>
