...
<div class="grid autofit-grid2 gap-12 p-2 mb-8">
    ...
    <div class="rounded-lg shadow-lg bg-dark-brown text-center flex flex-col justify-around h-52">
        ...
        <a href="index.php?page=product_trends"><span class="text-gray text-2xl">Products</span></a>
            ...
            if (count($orders) > 0){
                ...
                <tr class="border-color" data-id="<?= $order['id'] ?>">
                    ...
                    <?php if ($order['status']===2) { ?>
                        <select title="Status" class="text-white text-medium text-sm bg-transparent whitespace-nowrap rosarivo status-select" name="status" data-id="<?= $order['id'] ?>">
