...
if ($searchTerm !== '') {
    $select_staffs = $conn->prepare("SELECT u.id, u.image, u.name, u.uid, SUM(o.amount) AS total, SUM(o.quantity) AS quantity FROM users u LEFT JOIN orders o ON u.uid = o.uid WHERE name LIKE ? GROUP BY u.uid");
